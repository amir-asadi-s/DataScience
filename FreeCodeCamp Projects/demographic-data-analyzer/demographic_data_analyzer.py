...
def calculate_demographic_data(print_data=True):
    ...
    # Calculate population earning >50K per country
    greater_than_50k_by_country = df[df['salary'] == '>50K']['native-country'].value_counts()
    # Calculate the percentage of people earning >50K in each country
    percentage_by_country = round((greater_than_50k_by_country / total_by_country) * 100, 1)
